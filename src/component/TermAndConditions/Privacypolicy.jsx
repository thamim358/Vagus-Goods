    ...
    <>
      ...
      <div className="min-h-screen p-6">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded shadow-md">
          <h1 className="text-3xl font-semibold mb-6 text-[#FF7900]">Privacy Policy</h1>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-500">
              <li>Provide and improve Our services, including logistics arrangements and shipments.</li>
              <li>Communicate with You regarding orders, shipment updates, and personalized offers.</li>
              {/* Add more content */}
            </ul>
            {/* Add more content */}
          </div>
          ...
          <div className="mt-8">
            ...
            <p className='text-gray-500'>
              ...
              <a href="mailto:vagusgoodslogistics@gmail.com" className="text-blue-500">vagusgoodslogistics@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
